...
solar <- readRDS('/Users/Sumant Duggal/Downloads/project(1) (1)/solar_dataset.RData')
station_info <- read.csv('/Users/Sumant Duggal/Downloads/project(1) (1)/station_info.csv')
addition_var <-  readRDS('/Users/Sumant Duggal/Downloads/project(1) (1)/additional_variables.RData')
